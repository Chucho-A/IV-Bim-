...
int main() {
    ...
    while (true) {
        ...
        cout << "d. Buscar un empleado por nombre o identificacion y mostrar sus datos" << endl;
        ...
        if (opcion == 'a' || opcion == 'A') {
            ...
            if (!empleados.empty()) {
                ...
                cout << "No cuenta con empleados registrados." << endl;
            }
        } else if (opcion == 'e' || opcion == 'E') {
            cout << "Saliendo del programa." << endl;
            break;
        } else {
            cout << "Opcion invalida, seleccione una valida." << endl;
        }
    }
